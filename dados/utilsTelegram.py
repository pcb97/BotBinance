...
class BotTelegram:
	...
	def GetMessageUser(self,binance,i=0):
		try:
			comandos = ['/Graficos - Pode adicionar "-x" para pegar outros periodos x. EX: Graficos-50','/Posicoes - Ver posições abertas','/Acumulado - Mostra o acumulado da moeda', '/Desativar', '/Ativar']
			print("TELEGRAM PRONTO")
			if i==0:
			...
			self.bot.polling()
		except: return self.GetMessageUser(binance,i+1)
